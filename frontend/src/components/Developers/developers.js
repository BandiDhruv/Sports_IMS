        ...
        <div className="developer-container">
          <div className="developer-container-1">
            <div className="developer-box">
              <img
                src={process.env.PUBLIC_URL + "/assets/Dhruv.jpg"}
                alt="na"
            ...
            <div className="developer-box">
              <img
                src={process.env.PUBLIC_URL + "/assets/Divyanshi.jpg"}
                alt="na"
                className="developer-image"
              />
              <div className="developer-box-line"></div>
          ...
          {/* <div className="developer-container-1">
            <div className="developer-box">
              <img
                src={process.env.PUBLIC_URL + "/assets/Abhinav.JPG"}
                alt="na"
                className="developer-image"
              />
              <div className="developer-box-line"></div>
            ...
            <div className="developer-box">
              <img
                src={process.env.PUBLIC_URL + "/assets/chandan.JPG"}
                alt="na"
                className="developer-image"
              />
              <div className="developer-box-line"></div>
          ...
          <div className="developer-container-1">
            <div className="developer-box">
              <img
                src={process.env.PUBLIC_URL + "/assets/Ananya.JPG"}
                alt="na"
                className="developer-image"
              />
              <div className="developer-box-line"></div>
